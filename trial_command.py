...
class TrialCommand(Command):
    def __init__(
        self, navigator: Navigator, currencies_manager: CurrenciesManager, trial_cost
    ):
    ...
    def execute(self):
        self._navigator.switch_to_play_state(
            LvlStage.GENERATE_TRIAL_RESULT
        )  # fixme it this relevant
